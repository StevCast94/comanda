...
async function main() {
  ...
  const items: Array<{
    ...
    // ── Proteínas (KITCHEN_2) ──────────────────────────────
    { name: "Pollo a la plancha", description: "Pechuga de pollo a la plancha con especias", basePrice: 4.50, category: "A la Carta", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 12,
      modifiers: [{ name: "Término medio", priceAdjustment: 0 }, { name: "Bien cocido", priceAdjustment: 0 }] },
    { name: "Seco de pollo", description: "Pollo guisado en salsa de cerveza y naranjilla", basePrice: 5.00, category: "A la Carta", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 15 },
    { name: "Seco de carne", description: "Carne de res guisada en salsa criolla", basePrice: 6.00, category: "A la Carta", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 18 },
    { name: "Chuleta frita", description: "Chuleta de cerdo frita dorada", basePrice: 5.50, category: "A la Carta", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 14 },
    { name: "Carne asada", description: "Corte de res a la parrilla", basePrice: 7.00, category: "Asados", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 20,
      modifiers: [{ name: "Término 1/4", priceAdjustment: 0 }, { name: "Término 3/4", priceAdjustment: 0 }, { name: "Bien asado", priceAdjustment: 0 }] },
    { name: "Pollo asado", description: "1/4 de pollo a las brasas", basePrice: 5.50, category: "Asados", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 18 },
    { name: "Churrasco", description: "Lomo fino a la parrilla", basePrice: 8.50, category: "Asados", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 15,
    ...
    { name: "Guatita", description: "Estómago de res en salsa de maní", basePrice: 5.50, category: "A la Carta", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 10 },
    { name: "Encebollado", description: "Sopa de albacora con yuca y cebolla encurtida", basePrice: 4.50, category: "A la Carta", type: MenuItemType.MAIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 8,
      modifiers: [{ name: "Con chifles", priceAdjustment: 0.50 }, { name: "Extra limón", priceAdjustment: 0 }] },
    { name: "Tilapia frita", description: "Filete de tilapia crujiente", basePrice: 6.00, category: "A la Carta", type: MenuItemType.PROTEIN, kitchen: KitchenStation.KITCHEN_2, prepTime: 12 },
    ...
    // ── Bebidas (BAR) ──────────────────────────────────────
    { name: "Coca-Cola", description: "Cola personal 400ml", basePrice: 1.00, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 1 },
    { name: "Sprite", description: "Sprite personal 400ml", basePrice: 1.00, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 1 },
    { name: "Agua mineral", description: "Agua sin gas 500ml", basePrice: 0.75, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 1 },
    { name: "Jugo de naranjilla", description: "Jugo natural de naranjilla", basePrice: 1.50, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 3 },
    { name: "Jugo de mora", description: "Jugo natural de mora", basePrice: 1.50, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 3 },
    { name: "Jugo de tomate de árbol", description: "Jugo natural", basePrice: 1.50, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 3 },
    { name: "Cerveza Pilsener", description: "Cerveza nacional 600ml", basePrice: 2.50, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 1 },
    { name: "Café de chuspa", description: "Café pasado tradicional", basePrice: 1.00, category: "Bebidas", type: MenuItemType.DRINK, kitchen: KitchenStation.BAR, prepTime: 3 },
