...
async function main() {
    ...
    const catMap = {};
    const categories = [
        { name: "Desayunos", type: client_1.CategoryType.BREAKFAST, sortOrder: 1 },
        { name: "Almuerzos", type: client_1.CategoryType.LUNCH, sortOrder: 2 },
        { name: "A la Carta", type: client_1.CategoryType.A_LA_CARTE, sortOrder: 3 },
        { name: "Asados", type: client_1.CategoryType.ASADO, sortOrder: 4 },
        { name: "Bebidas", type: client_1.CategoryType.BEVERAGE, sortOrder: 5 },
        { name: "Postres", type: client_1.CategoryType.DESSERT, sortOrder: 6 },
        { name: "Snacks", type: client_1.CategoryType.SNACK, sortOrder: 7 },
    ];
    ...
    const items = [
        ...
        { name: "Menestra de fréjol", description: "Menestra de fréjol rojo", basePrice: 1.50, category: "A la Carta", type: client_1.MenuItemType.SIDE, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 5 },
        { name: "Patacones", description: "Plátano verde frito y aplastado (6 uds)", basePrice: 2.00, category: "A la Carta", type: client_1.MenuItemType.SIDE, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 6 },
        { name: "Papas fritas", description: "Papas fritas crujientes", basePrice: 2.00, category: "A la Carta", type: client_1.MenuItemType.SIDE, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 7 },
        { name: "Ensalada fresca", description: "Lechuga, tomate, cebolla, aguacate", basePrice: 1.50, category: "A la Carta", type: client_1.MenuItemType.SIDE, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 3 },
        { name: "Maduro frito", description: "Plátano maduro frito", basePrice: 1.00, category: "A la Carta", type: client_1.MenuItemType.SIDE, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 4 },
        { name: "Yuca frita", description: "Bastones de yuca frita", basePrice: 1.50, category: "A la Carta", type: client_1.MenuItemType.SIDE, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 6 },
        // ── Desayunos (BOTH kitchens) ──────────────────────────
        { name: "Bolón de verde", description: "Bolón de verde con queso o chicharrón", basePrice: 3.50, category: "Desayunos", type: client_1.MenuItemType.MAIN, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 8,
        ...
        { name: "Higos con queso", description: "Higos en almíbar con queso fresco", basePrice: 2.50, category: "Postres", type: client_1.MenuItemType.DESSERT, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 3 },
        // ── Snacks (KITCHEN_1) ─────────────────────────────────
        { name: "Empanada de verde", description: "Empanada de verde con queso", basePrice: 1.50, category: "Snacks", type: client_1.MenuItemType.MAIN, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 5,
            modifiers: [{ name: "Con queso", priceAdjustment: 0 }, { name: "De carne", priceAdjustment: 0.50 }] },
        { name: "Humita", description: "Humita de choclo tierno", basePrice: 1.50, category: "Snacks", type: client_1.MenuItemType.MAIN, kitchen: client_1.KitchenStation.KITCHEN_1, prepTime: 3 },
    ];
    ...
    const desayunoCombo = await prisma.combo.create({
        data: {
            ...
            restaurantId: restaurant.id,
            type: client_1.ComboType.BREAKFAST,
